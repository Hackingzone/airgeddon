...
<div>
	<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top" style="display: inline;">
		...
		<img src="https://raw.githubusercontent.com/v1s1t0r1sh3r3/airgeddon/master/imgs/paypal_donate.png" border="0" name="submit" title="Show me the money!" style="cursor: pointer; cursor: hand;"/>
