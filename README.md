...
- WPS features: WPS scanning (wash). WPS Custom PIN association. WPS Pixie Dust attacks integrated using reaver and bully. WPS bruteforce PIN attacks. WPS online PIN database search for "known WPS PINs attack" and integration of the most common PIN generation algorithms<br/>
