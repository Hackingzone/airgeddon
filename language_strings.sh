...
function language_strings() {
	...
	arr["ENGLISH",445]="If you have ccze installed and are experiencing display errors or glitches at the capture / target scan windows, you should disable colorization in the option and language menu"
	arr["SPANISH",445]="Si tienes instalado ccze y experimentas errores de visualización o parpadeos en las ventanas de captura / exploración de objetivos, desactiva la colorización en el menú de opciones e idioma"
	arr["FRENCH",445]="${pending_of_translation} Si vous avez installé ccze et les erreurs d'affichage de l'expérience ou clignote fenêtres capture / cibles d'exploration, colorisation désactivée dans le menu des options et la langue"
	arr["CATALAN",445]="${pending_of_translation} Si tens instal·lat ccze i experimentes errors de visualització o pampallugues a les finestres de captura / exploració d'objectius, desactiva l'colorización al menú d'opcions i idioma"
	arr["PORTUGUESE",445]="${pending_of_translation} Se você tiver instalado erros ccze e exibição experiência ou piscando na captura de janelas / alvos de exploração, colorização off no menu de opções e linguagem"
	arr["RUSSIAN",445]="${pending_of_translation} Если у вас установлен ccze и возникают ошибки отображения или сбои в окнах захвата / целевого сканирования, вы должны отключить раскраску в меню параметров и языков"
	arr["GREEK",445]="${pending_of_translation} Εάν έχετε εγκαταστήσει ccze και αντιμετωπίζετε σφάλματα εμφάνισης ή δυσλειτουργίες στα παράθυρα σάρωσης / στόχευσης, θα πρέπει να απενεργοποιήσετε τον χρωματισμό στο μενού επιλογών και γλώσσας"
	...
	arr["SPANISH",449]="2.  Habilitar la actualización automática"
	arr["FRENCH",449]="${pending_of_translation} 2.  Activer la mise à jour automatique"
	arr["CATALAN",449]="${pending_of_translation} 2.  Habilita l'actualització automàtica"
	arr["PORTUGUESE",449]="${pending_of_translation} 2.  Activar a actualização automática"
	arr["RUSSIAN",449]="${pending_of_translation} 2.  Включение автоматического обновления"
	arr["GREEK",449]="${pending_of_translation} 2.  Ενεργοποίηση αυτόματης ενημέρωσης"

	arr["ENGLISH",450]="3.  Enable colorization (on some screen's output)"
	arr["SPANISH",450]="3.  Habilitar la colorización (en la salida de algunas pantallas)"
	arr["FRENCH",450]="${pending_of_translation} 3.  Activer la colorisation (a la sortie de certains écrans)"
	arr["CATALAN",450]="${pending_of_translation} 3.  Habilita la colorización (a la sortida d'algunes pantalles)"
	arr["PORTUGUESE",450]="${pending_of_translation} 3.  Activar colorização (na produção de algumas telas)"
	arr["RUSSIAN",450]="${pending_of_translation} 3.  Включение раскраски (на выходе некоторых экранов)"
	arr["GREEK",450]="${pending_of_translation} 3.  Ενεργοποίηση χρωματισμού (στην έξοδο του ορισμένες οθόνες)"
	...
	arr["SPANISH",455]="2.  Deshabilitar la actualización automática"
	arr["FRENCH",455]="${pending_of_translation} 2.  Désactiver la mise à jour automatique"
	arr["CATALAN",455]="${pending_of_translation} 2.  Deshabilita l'actualització automàtica"
	arr["PORTUGUESE",455]="${pending_of_translation} 2.  Desactivar a actualização automática"
	arr["RUSSIAN",455]="${pending_of_translation} 2.  Выключение автоматического обновления"
	arr["GREEK",455]="${pending_of_translation} 2.  Απενεργοποίηση αυτόματης ενημέρωσης"

	arr["ENGLISH",456]="3.  Disable colorization (on some screen's output)"
	arr["SPANISH",456]="3.  Deshabilitar la colorización (en la salida de algunas pantallas)"
	arr["FRENCH",456]="${pending_of_translation} 3.  Désactiver la colorisation (a la sortie de certains écrans)"
	arr["CATALAN",456]="${pending_of_translation} 3.  Deshabilita la colorización (a la sortida d'algunes pantalles)"
	arr["PORTUGUESE",456]="${pending_of_translation} 3.  Desactivar colorização (na produção de algumas telas)"
	arr["RUSSIAN",456]="${pending_of_translation} 3.  Отключение раскраски (на выходе некоторых экранов)"
	arr["GREEK",456]="${pending_of_translation} 3.  Απενεργοποίηση χρωματισμού (στην έξοδο του ορισμένες οθόνες)"
	...
	arr["FRENCH",460]="${pending_of_translation} Ils ont permis à des mises à jour automatiques"
