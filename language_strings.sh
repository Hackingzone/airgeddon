...
function language_strings() {
	...
	arr["FRENCH",438]="${pending_of_translation} Nous recherchons des traducteurs pour d'autres langues. Si vous voulez voir airgeddon dans votre langue maternelle et aussi connaître l'anglais, s'il vous plaît contactez-nous. Plus d'informations: ${normal_color}${urlgithub_wiki}/Contributing"
	arr["CATALAN",438]="${pending_of_translation} Busquem traductors per a altres idiomes. Si vols veure airgeddon en la teva llengua materna i més saps anglès, contacta'ns. Més informació a: ${normal_color}${urlgithub_wiki}/Contributing"
