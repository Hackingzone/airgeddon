...
function language_strings() {
	...
	footer_texts["ENGLISH",1]="If you enjoyed the script and encountered it useful, you can support the project making a donation. Through Paypal (${normal_color}${mail}${pink_color}) or sending a fraction of a bitcoin (${normal_color}${bitcoin}${pink_color}). Any amount, not matter how small (1, 2, 5 $/€) is welcome. More information and direct links to do it at: ${urlgithub_wiki}/Contributing"
	footer_texts["SPANISH",1]="Si te gustó el script y te pareció útil, puedes apoyar el proyecto haciendo una donación. A través de Paypal (${normal_color}${mail}${pink_color}) o enviando una fracción de bitcoin (${normal_color}${bitcoin}${pink_color}). Cualquier cantidad por pequeña que sea (1, 2, 5 $/€) es bien recibida. Más información y enlaces directos para realizarla en: ${urlgithub_wiki}/Contributing"
	...
	footer_texts["CATALAN",1]="${pending_of_translation} Si et va agradar el script i et va semblar útil, pots donar suport al projecte fent una donació. A través de Paypal (${normal_color}${mail}${pink_color}) o enviant una fracció bitcoin (${normal_color}${bitcoin}${pink_color}). Qualsevol quantitat per petita que sigui (1, 2, 5 $/€) és ben rebuda. Més informació i enllaços directes a per realitzar-la en: ${urlgithub_wiki}/Contributing"
	footer_texts["PORTUGUESE",1]="${pending_of_translation} Se você gostou do roteiro e eu achei que seria útil, você pode apoiar o projeto, fazendo uma doação. Através do PayPal (${normal_color}${mail}${pink_color}) ou enviando uma fração do bitcoin (${normal_color}${bitcoin}${pink_color}). Qualquer quantidade no entanto pequena (1, 2, 5 $/€) é bem recebido. Mais links diretos e para realizá-lo em: ${urlgithub_wiki}/Contributing"
	...
	arr["ENGLISH",437]="If you enjoyed the script and encountered it useful, you can support the project making a donation. Through Paypal (${normal_color}${mail}${pink_color}) or sending a fraction of a bitcoin (${normal_color}${bitcoin}${pink_color}). Any amount, not matter how small (1, 2, 5 $/€) is welcome. More information and direct links to do it at: ${urlgithub_wiki}/Contributing"
	arr["SPANISH",437]="Si te gustó el script y te pareció útil, puedes apoyar el proyecto haciendo una donación. A través de Paypal (${normal_color}${mail}${pink_color}) o enviando una fracción de bitcoin (${normal_color}${bitcoin}${pink_color}). Cualquier cantidad por pequeña que sea (1, 2, 5 $/€) es bien recibida. Más información y enlaces directos para realizarla en: ${urlgithub_wiki}/Contributing"
	...
	arr["GREEK",437]="${pending_of_translation} Εάν απολάμβανε το σενάριο και το συνάντησε χρήσιμο, μπορείτε να υποστηρίξετε το έργο κάνοντας μια δωρεά. Μέσω του Paypal (${normal_color}${mail}${pink_color}) ή αποστέλλοντας ένα κλάσμα bitcoin (${normal_color}${bitcoin}${pink_color}). Οποιοδήποτε ποσό, δεν έχει σημασία πόσο μικρό (1, 2, 5 $/€) είναι ευπρόσδεκτο. Περισσότερες πληροφορίες και άμεσες συνδέσεις για να το κάνετε στη διεύθυνση: ${urlgithub_wiki}/Contributing"
